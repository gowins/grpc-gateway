...
var (
	...
	createMicroTranslator      = flag.Bool("create_micro_translator", false, "create the translator for go-micro service")
)
...
func main() {
	...
	reg.SetUseMicroTranslator(*createMicroTranslator)
